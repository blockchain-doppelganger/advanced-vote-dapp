const contract_address= '0x975b507ed946d3706296822fccb7ba6c8f639fc4'
const abi =  [
	{
		"constant": true,
		"inputs": [
...
function createVote(){
    ...
    var myCallData = contract_instance.createVote.getData(candidatesBytes,conditionsBytes, title, chairman, startTimestamp, endTimestamp, public);
